...
# UVM IOCTL定义
UVM_IOCTL_BASE = lambda i: (0x46000000 + i)
UVM_TEST_IOCTL_BASE = lambda i: UVM_IOCTL_BASE(200 + i)

class UVMTestCmds(IntEnum):
    RNG_SANITY = UVM_TEST_IOCTL_BASE(1)
    RANGE_TREE_DIRECTED = UVM_TEST_IOCTL_BASE(2)
    RANGE_TREE_RANDOM = UVM_TEST_IOCTL_BASE(3)
    RM_MEM_SANITY = UVM_TEST_IOCTL_BASE(5)
    GPU_SEMAPHORE_SANITY = UVM_TEST_IOCTL_BASE(6)
    TRACKER_SANITY = UVM_TEST_IOCTL_BASE(12)
    PUSH_SANITY = UVM_TEST_IOCTL_BASE(13)
    CHANNEL_SANITY = UVM_TEST_IOCTL_BASE(14)
    CE_SANITY = UVM_TEST_IOCTL_BASE(16)
    LOCK_SANITY = UVM_TEST_IOCTL_BASE(18)
    PERF_UTILS_SANITY = UVM_TEST_IOCTL_BASE(19)
    KVMALLOC = UVM_TEST_IOCTL_BASE(20)
    PERF_EVENTS_SANITY = UVM_TEST_IOCTL_BASE(23)
    PERF_MODULE_SANITY = UVM_TEST_IOCTL_BASE(24)
    RANGE_ALLOCATOR_SANITY = UVM_TEST_IOCTL_BASE(25)
    FAULT_BUFFER_FLUSH = UVM_TEST_IOCTL_BASE(27)
    SEC2_SANITY = UVM_TEST_IOCTL_BASE(95)
    SEC2_CPU_GPU_ROUNDTRIP = UVM_TEST_IOCTL_BASE(99)
